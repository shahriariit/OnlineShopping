...
namespace MvcStore.Models
{
    public partial class ShoppingCart
    {
        ...
        public void AddToCart(Model model)
        {
            ...
            var cartItem = storeDB.Carts.SingleOrDefault(c => c.CartId == ShoppingCartId && c.ModelId == model.ModelId);
        ...
        public decimal GetTotal()
        {
            ...
            decimal? total = (from cartItems in storeDB.Carts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.Model.Price).Sum();
        ...
        public int CreateOrder(Order order)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                orderTotal += (item.Count * item.Model.Price);
